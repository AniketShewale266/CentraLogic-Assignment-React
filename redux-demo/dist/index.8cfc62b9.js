...
})({"feL4Q":[function(require,module,exports) {
...
function reducer(state = initialState, action) {
    switch(action.type){
        ...
        case CAPITALIZED:
            return {
                ...state,
                outputText: state.inputText.split(" ").map((word)=>word.charAt(0).toUpperCase() + word.slice(1).toLowerCase()).join(" ")
            };
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"cM14g"}]},["feL4Q","6rimH"], "6rimH", "parcelRequire9870")
